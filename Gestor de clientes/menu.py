...
def iniciar():
    while True:
        ...
        if opcion == '1':
            ...
            print(cliente) if cliente else print("Cliente no enconntrado.")
            ...
            if cliente:
                nombre = helpers.leer_texto(
                    2, 30, f"Nombre (de 2 a 30 char) [{cliente.nombre}]").capitalize()
                apellido = helpers.leer_texto(
                    2, 30, f"Apelldio (de 2 a 30 char) [{cliente.apellido}]").capitalize()
